  ...
  <div v-if="customer">
    <SectionCard :title="customer.name">
      ...
      <div class="detail-section">
        ...
        <div class="detail-grid">
          <div class="detail-item">
            ...
            <div class="detail-value text-capitalize">{{ customer.type }}</div>
          </div>
          <div class="detail-item" v-if="customer.type === 'company'">
            <div class="detail-label">VAT/TAX ID</div>
            <div class="detail-value">{{ customer.taxId || '—' }}</div>
          </div>
          ...
          <div class="detail-item" v-if="customer.type === 'company'">
            ...
            <div class="detail-value">{{ customer.website || '—' }}</div>
          </div>
      ...
      <div class="detail-section">
        ...
        <div v-if="customer.addresses?.length" class="address-list">
          <div class="address-card" v-for="a in customer.addresses" :key="a.id">
      ...
      <div class="detail-section">
        ...
        <div v-if="customer.contacts?.length" class="contact-list">
          <div class="contact-card" v-for="c in customer.contacts" :key="c.id">
