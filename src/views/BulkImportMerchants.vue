<template>
  <div class="row g-3">
    <div class="col-12">
      <h2 class="mb-3">Bulk Import Merchants</h2>
      <p class="text-muted">
        Import multiple merchants with their contacts and addresses from a CSV file
      </p>
    </div>
    ...
    <div class="col-lg-8">
        ...
        <div v-if="successCount > 0" class="card mb-4 border-success">
          ...
          <div class="card-body">
            <p class="mb-0">
              Successfully imported <strong>{{ successCount }}</strong> merchant(s).
            </p>
            <router-link to="/merchants" class="btn btn-primary mt-3">
              View Merchants
            </router-link>
          </div>
        </div>
      ...
      <div class="col-lg-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <ul class="small">
              <li><strong>name</strong> (required): Merchant name</li>
              <li><strong>type</strong> (required): 'company' or 'person'</li>
              <li><strong>email</strong>: Contact email</li>
              <li><strong>phone</strong>: Contact phone</li>
              <li><strong>taxId</strong>: Tax ID or TIN</li>
...
import {
  downloadCSV,
  parseCSV,
  generateMerchantSampleCSV,
  parseMerchantData
} from '@/utils/bulkImport'

export default {
  name: 'BulkImportMerchants',
  setup() {
    ...
    const downloadSample = () => {
      const csv = generateMerchantSampleCSV()
      downloadCSV('merchants_sample.csv', csv)
    }
    ...
    const processFile = async () => {
      ...
      try {
        ...
        const { merchants, errors: validationErrors } = parseMerchantData(result.data)
        ...
        // Add merchants to store
        merchants.forEach(merchant => {
          store.merchants.push(merchant)
        })

        successCount.value = merchants.length
