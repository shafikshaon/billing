import{r as K,e as v,s as p,k as Y,c as a,a as t,b as Z,w as B,f as tt,o as i,g as u,t as o,d as X,F as et,h as st,u as V}from"./index-CHdhSjhx.js";import{_ as nt}from"./SectionCard-D4lkJobp.js";const ot={key:0,class:"row g-3"},at={class:"col-12"},it={class:"d-flex justify-content-between mb-3"},dt={key:0},lt={key:1},rt={key:2,class:"text-muted small"},ct={key:3},ut={key:4,class:"text-muted small"},mt={key:0},pt={key:1},vt={class:"text-end"},ft={key:0},ht={class:"mb-2 info-block"},xt={class:"fw-semibold"},bt={key:0},yt={key:1,class:"text-muted small"},gt={key:2,class:"text-muted small"},_t={key:3,class:"text-muted small"},wt={key:0},Nt={key:1},$t={class:"table table-sm table-invoice align-middle mt-2"},kt={class:"fw-medium"},Tt={key:0,class:"text-muted small"},It={class:"text-end"},Ct={class:"text-end"},Ft={class:"text-end"},St={key:0},At={key:1},Dt={key:2},Mt={class:"text-end"},Pt={class:"mt-2 d-flex"},Vt={class:"totals-card"},Rt={class:"line"},jt={class:"line"},zt={class:"line grand"},qt={key:0,class:"mt-3 invoice-terms"},Lt={class:"text-muted"},Et={key:1,class:"mt-2"},Bt={style:{"white-space":"pre-wrap"}},Xt={key:1,class:"text-muted"},Wt={__name:"CreditNoteView",setup(Ut){const U=Y(),H=tt(),D=K(null),d=v(()=>(p.creditNotes||[]).find(s=>s.id===U.params.id)),y=v(()=>p.merchants.find(s=>s.id===d.value?.merchantId)),N=v(()=>p.customers.find(s=>s.id===d.value?.customerId)),k=v(()=>p.invoices.find(s=>s.id===d.value?.originalInvoiceId)),j=v(()=>y.value?.addresses||[]),z=v(()=>y.value?.contacts||[]),M=v(()=>j.value.find(s=>s.id===d.value?.merchantAddressId)||j.value?.[0]),T=v(()=>z.value.find(s=>s.id===d.value?.merchantContactId)||z.value?.[0]),q=v(()=>N.value?.addresses||[]),L=v(()=>N.value?.contacts||[]),R=v(()=>q.value.find(s=>s.id===d.value?.customerAddressId)||q.value?.[0]),I=v(()=>L.value.find(s=>s.id===d.value?.customerContactId)||L.value?.[0]);function C(s){const e=(Number(s.qty)||0)*(Number(s.unitPrice)||0),n=s.discountType||"none",m=Number(s.discountValue)||0,g=n==="percent"?e*m/100:n==="fixed"?(Number(s.qty)||0)*m:0;return Math.max(0,e-g)}const x=v(()=>{const s=d.value;if(!s)return{sub:0,tax:0,total:0};let e=0,n=0;for(const m of s.items||[]){const g=C(m);e+=g;const $=p.taxes.find(r=>r.id===m.taxId);$&&(n+=g*(Number($.rate)||0)/100)}return{sub:e,tax:n,total:e+n}});function Q(){d.value&&H.push(`/credit-notes/${d.value.id}/edit`)}function W(){if(!D?.value)return;const s=D.value.outerHTML,e=window.open("","_blank","noopener,noreferrer");e&&(e.document.write(`
    <html>
      <head>
        <meta charset="utf-8"/>
